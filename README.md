...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wxm2nsa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wxm2nsa.containers.anotherwebservice.com/
...
```
git clone git@github.com:ar9havan/container-wxm2nsa.git
cd container-wxm2nsa
```
...
```
docker attach container-wxm2nsa
```
